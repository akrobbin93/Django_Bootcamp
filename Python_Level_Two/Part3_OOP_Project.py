...
while comp.still_has_cards() and player.still_has_cards() :
    total_rounds += 1
    table_cards = []
    war_cards = []
    print("Computer card count: " + str(len(comp.hand.cards)))
    print(player.name + " card count: " + str(len(player.hand.cards)))
